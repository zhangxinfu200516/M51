...
* @param	__Gearbox_Rate 此处的减速比是针对于英雄的yaw电机和yaw轴的减速比，2:1，可以根据结构不同来修改，默认为一
 * @param __Encoder_Offset 编码器偏移, 默认0
 * @param __Omega_Max 最大速度, 需根据不同负载测量后赋值, 也就开环输出用得到, 不过我感觉应该没有奇葩喜欢开环输出这玩意
 */
void Class_DJI_Motor_GM6020::Init(CAN_HandleTypeDef *hcan, Enum_DJI_Motor_ID __CAN_ID, Enum_DJI_Motor_Control_Method __DJI_Motor_Control_Method, float __Gearbox_Rate,int32_t __Encoder_Offset, float __Omega_Max)
{
