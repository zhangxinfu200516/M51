...
struct Struct_Referee_Rx_Data_Robot_Buff
{
    ...
    uint8_t Percentage_Of_Residual_Energy;
    uint16_t CRC_16;
} __attribute__((packed));
...
Enum_Referee_Data_Status Class_Referee::Get_Event_Supply_Status(uint8_t Supply_ID)
{
    ...
    break;
		default :
				return (Enum_Referee_Data_Status)0;
			break;
    }
 ...
 */
#ifdef GIMBAL
void Class_Referee::Set_Booster_42mm_1_Heat_CD(uint16_t __Booster_42mm_1_Heat_CD)
{
    this->Robot_Status.Shooter_Barrel_Cooling_Value = __Booster_42mm_1_Heat_CD;
}
#endif
