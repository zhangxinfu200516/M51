...
struct Struct_IIC_Manage_Object IIC1_Manage_Object = {0};
struct Struct_IIC_Manage_Object IIC2_Manage_Object = {0};
struct Struct_IIC_Manage_Object IIC3_Manage_Object = {0};
